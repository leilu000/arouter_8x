...
public class InterceptorProcessor extends BaseProcessor {
        ...
        if (CollectionUtils.isNotEmpty(elements)) {
            ...
            for (Element element : elements) {
                if (verify(element)) {  // Check the interceptor meta
                    ...
                    System.out.println("---------------- A interceptor verify failed, its " + element.asType());
                }
            }
    ...
    private boolean verify(Element element) {
        ...
        //    boolean flag = null != interceptor && ((TypeElement) element).getInterfaces().contains(iInterceptor);
